...
#Introduce one new additional data point into your assigned dataset
one_new <- data.frame("Maruti Swift Dzire VDi",2009,270000,150000,"Diesel","Individual","Manual" ,"Second Owner","19.5 kmpl", "1248 CC","74 bhp","190Nm@ 2000rpm",5)
names(one_new) <- c("name", "year", "selling_price", "km_driven", "fuel","seller_type","transmission","owner","mileage","engine","max_power","torque","seats")
