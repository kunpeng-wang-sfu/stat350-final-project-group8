...
Car_details_v3 = cbind(Name, Car_details_v3)
...
car <- subset(car, select = -c(fuel, seller_type, transmission, owner, mileage, engine, max_power))
head(car)

lm1 <- lm(selling_price ~ . - name - torque - manufacturer, data = car)
summary(lm1)
anova(lm1)
plot(lm1)
vcov(lm1)
...
robust.lm <- rlm(selling_price ~ . - name - torque - manufacturer,
